...
import org.cloud.sonic.simple.models.domain.Versions;
import org.cloud.sonic.simple.models.dto.VersionsDTO;
import org.cloud.sonic.simple.models.http.RespEnum;
import org.cloud.sonic.simple.models.http.RespModel;
import org.cloud.sonic.simple.services.VersionsService;
...
@Api(tags = "版本迭代相关")
@RestController
@RequestMapping("/api/controller/versions")
